import * as baseBehavior from '../helpers/baseBehavior'
import * as mergeOptionsToData from '../helpers/mergeOptionsToData'
...
Component({
    behaviors: [baseBehavior.default],
    externalClasses: ['wux-class'],
    data: mergeOptionsToData.default(defaults),
    methods: {
        /**
         * 显示
         */
