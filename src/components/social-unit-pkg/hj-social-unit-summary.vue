<template>
  <div class="hj-social-unit-summary">
    ...
    <div class="hj-social-unit-summary__base-info hj-social-unit-summary--shadow-box hj-social-unit-summary--radius">
      <div class="hj-social-unit-summary__base-info__content hj-social-unit-summary__base-info__content--heightlight">社会单位：{{socialUnit}}</div>
...
export default {
  ...
  methods: {
    ...
    initChart(data) {
      ...
      this.ecPie.options = pieFun({ data: pieData, total });
