...
export default {
  ...
  mounted() {
    console.log('assignmentNewOrder mounted');
    console.log(
      'assignmentNewOrder this.$root.$mp.query',
      this.$root.$mp.query
    );
    // if (!this.isReset) {
    //   this.isReset = true;
    // }
    if (!this.assignmentNewOrderCount) {
      this.assignmentNewOrderCount = 1;
    } else {
      this.assignmentNewOrderCount++;
    }
    console.log('this.assignmentNewOrderCount', this.assignmentNewOrderCount);
  ...
  beforeCreate() {
    console.log('assignmentNewOrder beforeCreate');
  },
  created() {
    console.log('assignmentNewOrder created');
  },
  beforeMount() {
    console.log('assignmentNewOrder beforeMount');
  },
  beforeUpdate() {
    console.log('assignmentNewOrder beforeUpdate');
  },
  updated() {
    console.log('assignmentNewOrder updated');
  },
  beforeDestroy() {
    console.log('assignmentNewOrder beforeDestroy');
  },
  destroyed() {
    console.log('assignmentNewOrder destroyed');
  }
};
</script>
<style lang="scss">
