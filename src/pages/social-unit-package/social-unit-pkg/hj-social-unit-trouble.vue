...
// import hjSocialUnitTroublePanel from "@/components/social-unit-pkg/hj-social-unit-trouble-panel.vue";
import hjSocialUnitTroublePanel from "./hj-social-unit-trouble-panel.vue";
...
export default {
  ...
  name: "hj-social-unit-trouble",
  mixins: [wuxToptips, isMounted, setScrollTop],
  components: {
    // hjDeviceTroublePanel,
    // hjFilter,
    // hjSimpleDatePicker,
    // hjSocialUnitTroublePanel: () => import("./hj-social-unit-trouble-panel.vue"),
    hjSocialUnitTroublePanel
  },
  props: {
    id: {
  ...
  methods: {
    ...
    processData(dataArr) {
      ...
      return dataArr.map(item => {
        ...
        var address = (item.device && item.device.address) || "";
    ...
    initData(params = {}, cb) {
      ...
      var newParams = { ...this.params, ...params, id };
