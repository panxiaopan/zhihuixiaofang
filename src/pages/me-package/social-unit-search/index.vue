<template>
  <div class="hj-social-unit-search">
    <wux-search-bar
      v-if="!isShowMap"
      wux-class="hj-social-unit-search__search"
      class="hj-social-unit-search__search"
      :value="keyword"
      :auto="auto"
    ...
    <div
      ...
      class="hj-social-unit-search__history"
    >
      <div class="hj-social-unit-search__history__hd">
        <div class="hj-social-unit-search__history__hd__label">
          历史搜索
        </div>
        <div
          class="hj-social-unit-search__history__hd__rubbish"
      ...
      <div
        ...
        class="hj-social-unit-search__history__list"
      >
        <wux-tag
          wux-class="hj-social-unit-search__history__list__li"
    ...
    <div
      ...
      class="hj-social-unit-search__detail-list"
    >
...
import socialUnitPanelWithoutSwipeout from "../components/social-unit-panel-without-swipeout.vue";
export default {
  onLoad() {
  ...
  onReady() {
    ...
    var searchList = wx.getStorageSync("socialUnitSearchList");
  ...
  onUnload() {
    ...
    wx.setStorageSync("socialUnitSearchList", [...this.searchList]);
  },
  onReachBottom(e) {
  ...
  methods: {
    ...
    processSocialUnitDataForPanel(row) {
      var title = row.name;
      var addrjson = row.addrjson;
      var suffix = addrjson.province + addrjson.city + addrjson.county;
      //  var leftImage =
      var manResponsibleForFireSecurity = row.manResponsibleForFireSecurity;
      var contentList = [
        { label: "责任人", value: manResponsibleForFireSecurity.name },
        { label: "联系方式", value: manResponsibleForFireSecurity.tel },
        { label: "安装日期", value: row.installedDate }
      ];
      ...
      return {
        ...
        contentList,
        extra: {
          phoneNumber: manResponsibleForFireSecurity.tel
        }
      };
    },
    setDetailData(list) {
    ...
    clickList(dtli) {
      console.log("clickList", dtli);
      wx.navigateTo({
        url: "/pages/me-package/edit-social-unit/main?id=" + dtli.id
      });
    },
    setInitData() {
      this.loading = false;
  ...
  mounted() {
    ...
    this.url =
      query.url && query.url != "undefined" ? query.url : "socialUnitsConfig"; // socialUnitsDetailList socialUnitsConfig
